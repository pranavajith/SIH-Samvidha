...
import ChatbotAnimation from './ChatbotAnimation'; // Import the animation component
...
const ChatBot = () => {
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            let chatbotResponse = await response.text() || "Sorry, I didn't understand that.";
        ...
        <div className="askai">
            {animationVisible && (
                <div className="animation-placeholder">
                    <ChatbotAnimation />
                    <p className="welcome-message">Welcome! Ask me about the Indian Constitution.</p>
                </div>
            )}
